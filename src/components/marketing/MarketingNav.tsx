...
function MegaMenu({ groups, wide = false }: { groups: MegaData; wide?: boolean }) {
 ...
 className="absolute top-full left-1/2 -translate-x-1/2 mt-3 z-50"style={{ width: wide ? 780 : 620 }}
 >
 {/* Flecha */}
 <div className="absolute -top-1.5 left-1/2 -translate-x-1/2 h-3 w-3 rotate-45 rounded-sm z-10"style={{ background: "#ffffff", border: "1px solid rgba(0,0,0,0.08)", clipPath: "polygon(0 0, 100% 0, 100% 100%)"}} />
 ...
 className="px-3 py-2"style={gi > 0 ? { borderLeft: "1px solid rgba(255,255,255,0.05)"} : {}}>
 <p className="mb-2 px-2 text-[10px] font-normal tracking-[2px] uppercase"style={{ color: "rgba(0,0,0,0.35)"}}>
 {group.heading}
 </p>
 ...
 <div className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-lg"style={{ background: `${link.color}18`, border: `1px solid ${link.color}30`}}>
 ...
 <Link href="/solutions"className="flex items-center gap-1 text-[11px] transition-colors hover:text-gray-900"style={{ color: "rgba(0,0,0,0.45)"}}>
...
function NavItem({
 ...
 return (
 <div className="relative"onMouseEnter={() => mega && setOpen(true)}
...
export function MarketingNav() {
 ...
 return (
 <header
 className="absolute top-0 left-0 right-0 w-full z-50 transition-all duration-300 [&>div]:relative"style={{
 ...
 <Link href="/login"className="text-[13px] font-normal transition-colors text-gray-500 hover:text-gray-900">
 Iniciar sesión
 </Link>
 <Link href="/contact"className="rounded-full px-5 py-2 text-[13px] font-normal text-white transition-opacity hover:opacity-75"style={{ background: "#2D1F3D"}}>
 ...
 className="overflow-hidden md:hidden"style={{ background: "#F4F3F5", borderTop: "1px solid rgba(0,0,0,0.07)"}}>
 ...
 className="block rounded-full py-2.5 text-center text-[13px] font-normal text-white"style={{ background: "#2D1F3D"}}>
 Contactar con ventas
 </Link>
 </div>
 </nav>
