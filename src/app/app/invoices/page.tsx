...
function NewInvoiceModal({ onClose, onCreated, products }: {
 ...
 {/* Cabecera */}
 <div className="grid text-[9px] font-bold uppercase tracking-widest text-slate-400 px-1 mb-1.5"style={{ gridTemplateColumns: "2fr 0.6fr 1fr 0.7fr 1fr 28px"}}>
 ...
 placeholder="Descripción del concepto…"className="rounded-md border border-slate-200 px-2.5 py-1.5 text-[12px] focus:border-indigo-400 focus:outline-none w-full"/>
 </div>
 <input value={l.quantity} onChange={e=>setLine(i,"quantity",e.target.value)} type="number"min="0"step="0.01"className="rounded-md border border-slate-200 px-2 py-1.5 text-[12px] text-right focus:border-indigo-400 focus:outline-none"/>
 <input value={l.unitPrice} onChange={e=>setLine(i,"unitPrice",e.target.value)} type="number"min="0"step="0.01"placeholder="0.00"className="rounded-md border border-slate-200 px-2 py-1.5 text-[12px] text-right focus:border-indigo-400 focus:outline-none"/>
 <input value={l.taxRate} onChange={e=>setLine(i,"taxRate",e.target.value)} type="number"min="0"step="0.5"className="rounded-md border border-slate-200 px-2 py-1.5 text-[12px] text-right focus:border-indigo-400 focus:outline-none"/>
 ...
 <div className="flex justify-between rounded-lg px-3 py-2 text-[12px] font-bold text-white"style={{ background: "linear-gradient(135deg,#6366f1,#8b5cf6)"}}>
 ...
 placeholder="Instrucciones de pago, agradecimiento, condiciones especiales…"className="w-full rounded-lg border border-slate-200 px-3 py-2 text-[12px] resize-none focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-100"/>
 </div>
 </form>
 ...
 disabled={saving}
 className="flex-1 flex items-center justify-center gap-2 rounded-xl py-2.5 text-[13px] font-semibold text-white disabled:opacity-60 transition"style={{ background: "linear-gradient(135deg,#6366f1,#8b5cf6)"}}
 >
...
function InvoicePreview({ payment, settings }: { payment: InvoicePayment; settings: InvoiceSettings }) {
 ...
 <div className="inline-block px-3 py-1.5 rounded-lg text-white font-bold text-[13px] mb-2"style={{ background: accent }}>
 ...
 <div className="flex justify-between rounded-lg px-3 py-2 mt-1 text-white font-bold text-[11px]"style={{ background: accent }}>
...
function SettingsPanel({ settings, onChange, onSave, saving }: {
 ...
 <input
 type="color"value={settings.accentColor ?? "#6366f1"}
 onChange={e => onChange("accentColor", e.target.value)}
 className="h-9 w-14 rounded-lg border border-slate-200 cursor-pointer p-0.5"/>
 <input
 type="text"value={settings.accentColor ?? "#6366f1"}
 onChange={e => onChange("accentColor", e.target.value)}
 ...
 <input
 type="text"value={settings.bankAccount ?? ""}
 onChange={e => onChange("bankAccount", e.target.value)}
 placeholder="ES91 2100 0418 4502 0005 1332"className="w-full rounded-lg border border-slate-200 px-3 py-2 text-[12px] font-mono focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-100"/>
 </div>
 ...
 placeholder="Gracias por confiar en nosotros. Para cualquier consulta..."className="w-full rounded-lg border border-slate-200 px-3 py-2 text-[12px] resize-none focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-100"/>
 </div>

 <button
 onClick={onSave}
 disabled={saving}
 className="flex items-center justify-center gap-2 rounded-xl px-5 py-2.5 text-[13px] font-semibold text-white transition disabled:opacity-60"style={{ background: "linear-gradient(135deg, #6366f1, #8b5cf6)"}}
 >
...
export default function InvoicesPage() {
 ...
 className="flex items-center gap-2 rounded-xl px-4 py-2.5 text-[13px] font-semibold text-white shadow-md transition"style={{ background: "linear-gradient(135deg,#6366f1,#8b5cf6)"}}
 >
 ...
 placeholder="Buscar por cliente, descripción o referencia…"className="w-full max-w-md rounded-xl border border-slate-200 bg-white pl-9 pr-4 py-2.5 text-[13px] text-slate-900 placeholder-slate-400 focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-100"/>
 </div>
 ...
 download
 className="flex items-center gap-1 rounded-lg px-2.5 py-1.5 text-[11px] font-semibold text-white transition"style={{ background: "linear-gradient(135deg,#6366f1,#8b5cf6)"}}
 >
 ...
 <button
 onClick={() => setShowNewInvoice(true)}
 className="flex items-center gap-2 rounded-xl px-4 py-2.5 text-[13px] font-semibold text-white"style={{ background: "linear-gradient(135deg,#6366f1,#8b5cf6)"}}
 >
 ...
 download
 className="flex items-center gap-1 rounded-lg px-2.5 py-1.5 text-[11px] font-semibold text-white"style={{ background: "linear-gradient(135deg,#6366f1,#8b5cf6)"}}
 >
 <Download className="h-3 w-3"/>PDF
 </a>
 <button
 ...
 {preview && (
 <div
 className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-black/60 py-8 px-4"onClick={e => { if (e.target === e.currentTarget) setPreview(null); }}
 >
 <div className="relative">
 {/* Botones */}
 ...
 download
 className="flex items-center gap-1.5 rounded-xl px-4 py-2 text-[12px] font-semibold text-white shadow-lg"style={{ background: "linear-gradient(135deg,#6366f1,#8b5cf6)"}}
 >
