...
export default function BillingSubscriptionsPage() {
 ...
 <Link href="/app/subscriptions"className="inline-flex items-center gap-2 rounded-xl bg-slate-900 px-5 py-2.5 text-[13px] font-semibold text-white hover:bg-slate-700 transition">
 Ir a Suscripciones →
 </Link>
 </div>
 </div>
