    ...
    <div className="p-8">
      ...
      <div className="mb-4 flex items-center gap-3">
        <input
          ...
          placeholder="Filtrar por tipo (ej: payment_intent)"
          className="flex-1 rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-[13px] outline-none shadow-sm"
        />
        <select
          value={status}
