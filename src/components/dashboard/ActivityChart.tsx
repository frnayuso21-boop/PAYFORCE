...
export function ActivityChart({ series }: { series: ChartPoint[] }) {
 ...
 strokeWidth="2"strokeLinecap="round"strokeLinejoin="round"opacity={allZero ? 0.55 : 1}
 />
 ...
 fontSize="8.5"fontFamily="system-ui, sans-serif"fill={hovered === i ? BLUE : "#94a3b8"}
 ...
 fill={BLUE_LIGHT}
 stroke="white"strokeWidth="2"style={{ transition: "r 0.12s"}}
 />
 )}
 </g>
 ))}
 ...
 <div
 className="pointer-events-none absolute z-20"style={{
 bottom: `calc(100% - ${(ys[hovered] / H) * 100}% + 18px)`,
 left: xs[hovered] / W > 0.82 ? "auto": `max(0px, calc(${(xs[hovered] / W) * 100}% - 62px))`,
 right: xs[hovered] / W > 0.82 ? 4 : "auto",
 }}
 >
 <div
 className="rounded-xl shadow-xl overflow-hidden"style={{
 background: "#0f172a",
