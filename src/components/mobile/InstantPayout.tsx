    ...
    <>
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="text-left">
            <p className="text-[15px] font-bold text-white leading-tight">Pago inmediato</p>
      ...
      {open && (
        <>
          ...
          <div className="fixed bottom-0 left-0 right-0 z-[90] rounded-t-3xl bg-white shadow-2xl"
            ...
            <div className="px-4 pt-4">
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <p className="text-[16px] font-bold text-slate-900">Pago inmediato</p>
              ...
              {!loading && data && step !== "done" && (
                <div className="space-y-3 pb-4">
                  ...
                  <div className="rounded-2xl bg-slate-50 border border-slate-200 p-4">
                    ...
                    <p className="text-[38px] font-bold text-slate-900 tabular-nums leading-none">
                    ...
                    <>
                      ...
                      <div className="rounded-2xl border border-slate-200 overflow-hidden">
                        ...
                        <div className="flex justify-between px-4 py-3.5 bg-emerald-50 border-t border-emerald-100">
                          <span className="text-[14px] font-bold text-emerald-700">Recibirás</span>
                          <span className="text-[18px] font-bold text-emerald-700">{fmt(displayNet, data.currency)}</span>
                        </div>
                      </div>
                      ...
                      <button
                        ...
                        className="w-full h-[54px] rounded-2xl bg-gradient-to-r from-amber-400 to-orange-400 text-white text-[16px] font-bold disabled:opacity-40 active:scale-[0.98] flex items-center justify-center gap-2.5"
                      >
                        {sending
