        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-200 bg-slate-50 px-3.5 py-2.5 text-[13px] text-slate-800 outline-none focus:border-slate-400 focus:bg-white transition"
            />
          </div>
        ...
        <div className="max-h-[70vh] overflow-y-auto p-5 bg-[#f5f5f7]">
          <div className="rounded-2xl overflow-hidden bg-white shadow-sm text-[13px]">
            <div className="bg-[#1d1d1f] px-6 py-5">
              ...
              <h3 className="text-[18px] font-bold text-white mb-1">Informe semanal</h3>
            ...
            <div className="px-6 py-5 space-y-4">
              ...
              <div className="bg-[#f5f5f7] rounded-xl px-4 py-3 flex items-center gap-2">
                ...
                <span className="text-[14px] font-bold text-green-600">+12,3%</span>
              </div>
                    ...
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="flex items-center gap-1 rounded-lg border border-slate-200 px-2.5 py-1.5 text-[11px] font-medium text-slate-600 hover:bg-slate-50 disabled:opacity-50 transition-colors"
                        >
                          {sending === manager.id ? (
