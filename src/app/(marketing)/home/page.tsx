  ...
  return (
    <div style={{ background: "#000000" }}>
      ...
      <section className="relative overflow-hidden bg-white" style={{ minHeight: "100svh", borderRadius: "0 0 120px 120px", boxShadow: "0 40px 120px rgba(0,0,0,0.65)", position: "relative", zIndex: 10 }}>
        ...
        {/* ── Contenido ── */}
        <div className="relative z-10 flex flex-col items-center pt-16 md:pt-20 px-4">
      ...
      {/* ── CTA FINAL ───────────────────────────────────────────────── */}
      <section className="relative px-4 py-12 text-center md:px-6 md:py-20 overflow-hidden mx-4 md:mx-8 mt-8 md:mt-14 mb-4 md:mb-8"
        style={{
