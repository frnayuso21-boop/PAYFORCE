    ...
    return (
      <main className="flex min-h-screen items-center justify-center bg-gradient-to-b from-slate-50 to-white p-4">
        <div className="w-full max-w-sm text-center space-y-5">
          ...
          <Link
            href="/app/dashboard"
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-slate-900 px-6 py-3 text-sm font-semibold text-white hover:bg-slate-800 transition-colors"
          >
            Ir al dashboard
          </Link>
        </div>
          ...
          <div className="space-y-2.5">
            {isGmail && (
              <a
                ...
                className="flex w-full items-center justify-center gap-2.5 rounded-xl bg-slate-900 px-4 py-3 text-sm font-semibold text-white hover:bg-slate-800 transition-colors"
              >
