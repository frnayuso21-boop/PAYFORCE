...
function ActionBadge({ action }: { action: string }) {
 ...
 return (
 <span
 className="inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-[11px] font-semibold"style={{ backgroundColor: cfg.bg, color: cfg.text }}
 >
 {cfg.icon}{cfg.label}
 </span>
 );
...
export default function AuditLogPage() {
 ...
 {/* Cabecera */}
 <div className="grid border-b border-slate-100 bg-slate-50 px-5 py-3 text-[11px] font-semibold uppercase tracking-wider text-slate-400"style={{ gridTemplateColumns: "1.8fr 1fr 1fr 1fr 1.2fr"}}>
 <span>Acción</span>
 <span>IP</span>
 ...
 {[...Array(8)].map((_, i) => (
 <div key={i} className="grid items-center px-5 py-3.5"style={{ gridTemplateColumns: "1.8fr 1fr 1fr 1fr 1.2fr"}}>
 ...
 <div
 key={log.id}
 className="grid items-center px-5 py-3.5 hover:bg-slate-50/70 transition-colors"style={{ gridTemplateColumns: "1.8fr 1fr 1fr 1fr 1.2fr"}}
 >
