...
export function FloatingButton() {
 ...
 {open && (
 <div
 className="fixed inset-0 z-[60] bg-black/30 md:hidden"onClick={() => setOpen(false)}
 />
 )}
 ...
 action.highlight
 ? "bg-slate-900 active:bg-slate-800": "bg-slate-50 active:bg-slate-100")}
 >
 <div className={cn(
 "flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border",
 action.highlight
 ? "bg-white/15 border-white/20": "bg-white border-slate-200")}>
