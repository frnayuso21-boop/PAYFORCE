...
export default function QrPaymentPage() {
 ...
 <p className="text-[32px] font-normal text-slate-900">{fmtCents(cents)}</p>
 ...
 className="mt-8 rounded-2xl bg-slate-900 px-8 py-3.5 text-[14px] font-normal text-white hover:bg-slate-700 transition">
 Nuevo cobro
 </button>
 </div>
 );
 ...
 <p className="text-[28px] font-normal text-slate-900">{fmtCents(cents)}</p>
 ...
 <img ref={imgRef} src={qrDataUrl} alt="QR de pago"className="w-full max-w-[320px] rounded-2xl"/>
 ...
 <p className="text-[32px] font-normal text-slate-900 mb-6">{fmtCents(cents)}</p>
 ...
 <p className="text-[44px] font-normal text-slate-900 leading-none min-h-[52px]">
 {amount
 ...
 className="w-full rounded-2xl bg-slate-900 py-4 text-[15px] font-normal text-white hover:bg-slate-700 disabled:opacity-40 transition flex items-center justify-center gap-2">
 {loading
 ...
 <a href="/app/connect/onboarding"className="mt-2.5 flex items-center gap-1 text-[12px] font-semibold text-red-700 underline underline-offset-2">
