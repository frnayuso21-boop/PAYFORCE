...
export default function CustomersPage() {
 ...
 {search
 ? "Prueba con otro nombre o email": "Los clientes aparecerán cuando completen un pago"}
 </p>
 </div>
 ) : (
 filtered.map(c => {
 ...
 {/* Avatar */}
 <div
 className="h-8 w-8 rounded-full flex items-center justify-center text-[11px] font-bold shrink-0"style={{ backgroundColor: av.bg, color: av.text }}
 >
 {initials(c.name)}
 </div>
 {/* Info */}
 ...
 <div
 className="h-12 w-12 rounded-full flex items-center justify-center text-[16px] font-bold shrink-0"style={{ backgroundColor: avatarColor(selected.name).bg, color: avatarColor(selected.name).text }}
 >
 ...
 {customers.length === 0
 ? "Aparecerán aquí cuando completen un pago": "Haz clic en un cliente para ver sus detalles"}
 </p>
 </div>
 {customers.length === 0 && (
 <button
