 ...
 *
 * ⚠️  FALLBACK DE EMERGENCIA — NO usar como flujo principal.
 *
...
export async function GET(req: NextRequest) {
  try {
    ...
    // Las cuentas nuevas con controller.stripe_dashboard.type: "none"
    // no tienen login link — se gestionan 100% via embedded components
    try {
