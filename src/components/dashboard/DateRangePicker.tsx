          ...
          return (
            <button
              ...
              className={cn(
                ...
                isFrom || isTo
                  ? "bg-slate-900 text-white z-10 font-semibold"
                  : inRange
      ...
      <button
        ...
        className={cn(
          ...
          open
            ...
            : "border-slate-200 bg-white text-slate-600 hover:border-slate-300 hover:text-slate-900 shadow-[0_1px_2px_rgba(0,0,0,0.04)]",
        )}
      >
              ...
              <div className="flex items-center justify-between border-b border-slate-100 px-4 py-3">
                ...
                <span className="text-[11px] text-slate-400">
                  {!from
                    ...
                    : !to
                    ? "Selecciona el fin"
                    : <span className="font-medium text-slate-700">{formatRange({ from, to })}</span>
                  }
                </span>
                <button
                  type="button"
