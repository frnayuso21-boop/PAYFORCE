...
function ProductModal({
 ...
 placeholder="Describe brevemente el producto o servicio…"className="w-full rounded-lg border border-slate-200 px-3 py-2 text-[12px] resize-none focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-100"/>
 </div>
 ...
 placeholder="0.00"className="flex-1 px-2.5 py-2 text-[12px] outline-none"/>
 </div>
 </div>
 {/* Divisa */}
 <div>
 ...
 placeholder="https://…"className="w-full rounded-lg border border-slate-200 px-3 py-2 text-[12px] focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-100"/>
 </div>
...
function ProductCard({ product, onEdit, onDelete, onToggle }: {
 ...
 className="rounded-lg border border-slate-200 px-3 py-2 text-[11px] text-slate-500 hover:bg-slate-50 transition"title={product.active ? "Desactivar": "Activar"}
 >
...
export default function ProductsPage() {
 ...
 className="flex items-center gap-2 rounded-xl px-4 py-2.5 text-[13px] font-semibold text-white shadow-md transition hover:shadow-lg"style={{ background: "linear-gradient(135deg,#6366f1,#8b5cf6)"}}
 >
 ...
 placeholder="Buscar por nombre, SKU…"className="rounded-xl border border-slate-200 bg-white pl-9 pr-4 py-2.5 text-[13px] placeholder-slate-400 focus:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-100 w-64"/>
 </div>
 {categories.length > 0 && (
 <div className="relative">
 <select
