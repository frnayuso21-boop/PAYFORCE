...
export function PaySuccess({
 ...
 ? `PF-${new Date().getFullYear()}-${paymentId.slice(-4).toUpperCase()}`: `PF-${new Date().getFullYear()}-XXXX`;
 ...
 <polyline
 points="10,26 20,36 38,16"stroke="#10B981"strokeWidth="5"strokeLinecap="round"strokeLinejoin="round"fill="none"style={{
 strokeDasharray: 50,
 ...
 <path d="M12 2v13M8 11l4 4 4-4M2 17v2a2 2 0 002 2h16a2 2 0 002-2v-2"stroke="#0A0A0A"strokeWidth="1.5"strokeLinecap="round"strokeLinejoin="round"/>
 </svg>
