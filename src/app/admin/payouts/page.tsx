...
export default function AdminPayoutsPage() {
 ...
 filter === s
 ? "bg-slate-900 text-white": "bg-white border border-slate-200 text-slate-500 hover:bg-slate-50"}`}
 >
 {s}
 </button>
 ))}
 ...
 placeholder="po_xxx o referencia SEPA"className="mt-1 w-full rounded-lg border border-slate-200 px-3 py-2 text-[13px] outline-none focus:ring-2 focus:ring-slate-300"/>
 </div>
 ...
 rows={2}
 placeholder="Observaciones opcionales…"className="mt-1 w-full rounded-lg border border-slate-200 px-3 py-2 text-[13px] outline-none focus:ring-2 focus:ring-slate-300 resize-none"/>
 </div>
