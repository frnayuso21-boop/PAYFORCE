...
function OtpInput({ value, onChange, disabled }: { value: string; onChange: (v: string) => void; disabled?: boolean }) {
 ...
 className="h-12 w-10 rounded-xl border-2 border-slate-200 bg-white text-center text-[20px] font-semibold text-slate-900 outline-none transition-all focus:border-slate-800 focus:ring-2 focus:ring-slate-100 disabled:opacity-50"style={{ caretColor: "transparent"}}
 />
 ))}
 </div>
 );
...
export default function SecurityPage() {
 ...
 <Link
 href="/dashboard/security"className="mt-3 inline-block text-[13px] font-medium text-[#0071e3] hover:underline">
 ...
 <button
 type="button"onClick={() => { setStep("idle"); void loadStatus(); }}
 ...
 <button
 type="button"onClick={() => void startEnroll()}
 ...
 {step === "enrolling"? <Loader2 className="h-3.5 w-3.5 animate-spin"/>
