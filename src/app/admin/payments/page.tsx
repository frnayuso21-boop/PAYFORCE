...
function RefundModal({
 ...
 type === v
 ? "border-slate-900 bg-slate-900 text-white": "border-slate-200 bg-white text-slate-600 hover:border-slate-300"}`}
 >
 {l}
 </button>
 ))}
 ...
 <input
 type="number"step="0.01"min="0.01"max={(remaining / 100).toFixed(2)}
 value={amountStr}
...
export default function PaymentsPage() {
 ...
 placeholder="Buscar por PI, email de cliente…"className="flex-1 text-[13px] outline-none placeholder:text-slate-300"/>
 </div>
 <select
 value={status}
