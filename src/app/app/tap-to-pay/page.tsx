...
function NfcWaves({ active }: { active: boolean }) {
 ...
 active
 ? "border-white/40 bg-white/10": "border-white/20 bg-white/5")}>
 ...
 */
 ...
 <input
 type="text"placeholder="Concepto (opcional)"value={description}
 onChange={(e) => setDescription(e.target.value)}
 className="mt-1 w-52 rounded-2xl bg-white/8 px-4 py-2.5 text-center text-[14px] text-white placeholder:text-white/25 outline-none focus:bg-white/12 transition"maxLength={60}
 />
 ...
 className="w-full h-[58px] rounded-2xl bg-white text-[#0a0a0f] text-[17px] font-normal active:scale-[0.98] disabled:opacity-30 transition-all flex items-center justify-center gap-2.5">
 {loading
 ...
 */
 ...
 <p className="text-[52px] font-normal tabular-nums leading-none">
 ...
 {/* Animación NFC */}
 <div
 className="cursor-pointer active:scale-95 transition-transform"onClick={simulateNfc}
 >
 ...
 */
 ...
 <div className="text-center">
 <p className="text-[24px] font-normal">Pago rechazado</p>
 <p className="mt-1 text-[14px] text-white/40">La tarjeta fue denegada</p>
 </div>
 <button onClick={reset} className="mt-4 w-full max-w-xs h-[54px] rounded-2xl bg-white text-[#0a0a0f] text-[16px] font-normal active:scale-[0.98]">
 Reintentar
 </button>
 </div>
 );
 ...
 */
 ...
 <div>
 <p className="text-[42px] font-normal leading-none mb-1">
 €{formatDisplay(String(paidAmount))}
 </p>
 ...
 <button
 onClick={reset}
 className="w-full max-w-xs h-[54px] rounded-2xl bg-white text-[#0a0a0f] text-[16px] font-normal active:scale-[0.98] transition-all">
 Nuevo cobro
 </button>
