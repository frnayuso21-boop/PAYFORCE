...
export default async function PayoutsPage() {
 ...
 <p className="mt-2 text-[18px] font-normal tabular-nums text-slate-900 text-center leading-none">
 {item.value}
 </p>
 </div>
 ))}
 ...
 <p className="text-[15px] font-normal tabular-nums text-slate-900 leading-tight">
 ...
 {splits.length === 0 ? (
 <EmptyState
 icon=""title="Sin liquidaciones todavía"description="Las liquidaciones aparecerán aquí cuando se procesen pagos a través de PayForce."/>
 ) : (
 <>
