  ...
  return (
    <div className="h-full rounded-2xl border border-slate-100 bg-white p-5 shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
      ...
      <div className="flex items-start justify-between">
        ...
        <Link
          href="/app/connect"
          className="flex items-center gap-1 rounded-lg px-2 py-1 text-[11px] text-slate-400 hover:bg-slate-50 hover:text-slate-600 transition-colors"
        >
          Gestionar cuenta
        </Link>
      </div>
      ...
      {status !== "enabled" && (
        <Link
          ...
          className="mt-4 flex w-full items-center justify-center gap-1.5 rounded-xl bg-slate-900 px-4 py-2 text-[12px] font-semibold text-white transition-colors hover:bg-slate-800"
        >
