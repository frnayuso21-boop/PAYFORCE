    ...
    <div className="h-full px-4 pt-2" style={{ background: "#0d0d0d" }}>
      ...
      <div className="flex flex-col gap-2 mb-3">
        {[
          ...
          <div key={label} className="flex items-center gap-2 rounded-xl px-2.5 py-2"
      ...
      <div className="rounded-xl p-2.5"
        style={{ background: "rgba(13,223,200,0.07)", border: "1px solid rgba(13,223,200,0.18)" }}>
  ...
  return (
    <div className="relative w-full rounded-2xl overflow-hidden"
      ...
      <div className="pointer-events-none absolute top-0 left-0 right-0"
        style={{ height: 120, background: "radial-gradient(ellipse 80% 100% at 50% 0%, rgba(139,92,246,0.22) 0%, transparent 100%)" }} />
        ...
        {[
          ...
          <div key={r.label} className="flex items-center justify-between py-[3px]">
            ...
            <span className="text-[10px] font-semibold"
              style={{ color: r.ok ? "#4ade80" : "#fbbf24" }}>
              {r.value}
            </span>
          </div>
        ))}
  ...
  return (
    ...
    >
      <div className="relative flex">
        ...
        {/* ── Columna timeline ── */}
        <div className="relative hidden md:flex flex-col items-center pt-24 pb-24"
          style={{ width: 88, flexShrink: 0 }}>

          <div className="absolute top-0 bottom-0"
            style={{ left: 40, width: 4, borderRadius: 4, background: "rgba(22,22,42,0.08)" }} />

          <div className="absolute top-0 overflow-hidden"
            style={{ left: 40, bottom: 0, width: 4, borderRadius: 4 }}>
            <motion.div
              style={{
                height: lineHeight,
                width: "100%",
          ...
          {SECTIONS.map((s, i) => (
            <motion.div
              key={s.num}
              className="absolute flex h-11 w-11 items-center justify-center rounded-full text-[15px] font-semibold text-white"
              style={{
                left: 18,
                ...
                <div className={`mx-auto flex w-full max-w-4xl flex-col items-center gap-10 md:flex-row md:gap-20 ${s.flip ? "md:flex-row-reverse" : ""}`}>
                  ...
                  <div className="flex-1 flex flex-col gap-5">
                    <div className="flex md:hidden items-center gap-3">
                      <div className="flex h-9 w-9 items-center justify-center rounded-full text-[13px] font-medium text-white"
                        style={{ background: ACCENT }}>
                        {s.num}
                      </div>
                    </div>
                    <div>
                      <span className="text-[10px] tracking-[2.5px] uppercase"
