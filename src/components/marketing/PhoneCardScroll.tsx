  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0"
        style={{ background: "linear-gradient(140deg, #0d0621 0%, #2d0d6e 28%, #5b1fa8 58%, #7c3aed 82%, #a78bfa 100%)" }} />

      {/* Iridescent shimmer layer */}
      <div className="absolute inset-0"
        style={{ background: "linear-gradient(115deg, rgba(200,150,255,0.15) 0%, transparent 40%, rgba(100,200,255,0.08) 80%)" }} />

      {/* Top-half gloss */}
      <div className="absolute inset-x-0 top-0"
        style={{ height: "52%", background: "linear-gradient(160deg, rgba(255,255,255,0.10) 0%, rgba(255,255,255,0.02) 60%, transparent 100%)" }} />

      {/* Horizontal shimmer line */}
      <div className="absolute inset-x-0"
        style={{ top: "47%", height: 1, background: "linear-gradient(90deg, transparent, rgba(210,170,255,0.20) 30%, rgba(230,200,255,0.35) 50%, rgba(210,170,255,0.20) 70%, transparent)" }} />

      {/* Ambient glow orbs */}
      <div className="absolute rounded-full blur-3xl"
        style={{ width: 280, height: 180, top: -80, right: -60, background: "rgba(167,139,250,0.18)" }} />
      <div className="absolute rounded-full blur-2xl"
        style={{ width: 180, height: 120, bottom: -40, left: -30, background: "rgba(99,102,241,0.14)" }} />
      ...
      <div className="absolute flex items-center gap-2" style={{ top: 20, left: 22 }}>
        <svg viewBox="0 0 20 20" width={14} height={14} fill="none">
          <polygon points="10,1 18,5.5 18,14.5 10,19 2,14.5 2,5.5"
            fill="rgba(255,255,255,0.16)" stroke="rgba(255,255,255,0.38)" strokeWidth="1.2" />
          <polygon points="10,5 15,7.8 15,12.2 10,15 5,12.2 5,7.8"
      ...
      {/* Card number */}
      <div className="absolute tracking-[3.5px] font-light text-white/36"
        style={{ bottom: 42, left: 22, fontSize: 12, letterSpacing: "0.22em" }}>
        •••• •••• •••• 4291
      </div>
    ...
    <div className="flex flex-col h-full" style={{ background: "linear-gradient(180deg, #0c0c14 0%, #07070e 100%)" }}>
      ...
      <div className="relative mx-4">
        {[
          ...
          <div key={i} className="absolute inset-x-0 rounded-[14px] border border-white/[0.06]"
            style={{ top: c.top, height: 82, background: c.grad, zIndex: i + 1 }}>
        ...
        <div className="absolute inset-x-0 rounded-[14px] border border-violet-500/20 z-10"
          style={{ top: 28, height: 82, background: "linear-gradient(135deg,#2d0d6e,#1a0842)" }}>
  ...
  return (
    ...
    <div ref={containerRef} style={{ height: "260vh" }}>
      ...
      <div
        ...
        style={{ background: "#fafafa", perspective: 1200 }}
      >
        ...
        <div className="pointer-events-none absolute inset-0"
          style={{ background: "radial-gradient(ellipse 110% 100% at 50% 50%, transparent 40%, rgba(230,230,230,0.75))" }} />
        ...
        <motion.div
          className="absolute"
          style={{ scale: phoneScale, y: phoneY, opacity: phoneOpacity, zIndex: 10 }}
        >
