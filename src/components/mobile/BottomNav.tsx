...
export function BottomNav() {
 ...
 <div
 className="flex items-stretch"style={{
 ...
 <Icon
 className="h-[22px] w-[22px] transition-colors"strokeWidth={active ? 2.2 : 1.7}
 style={{ color: active ? theme.mobileNavActive : theme.mobileNavInactive }}
 />
 </div>
 <span
 className="text-[10px] font-medium"style={{ color: active ? theme.mobileNavActive : theme.mobileNavInactive }}
 >
 {tab.label}
 </span>
 </Link>
