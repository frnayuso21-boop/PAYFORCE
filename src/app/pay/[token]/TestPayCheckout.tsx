        ...
        <div className="relative flex h-24 w-24 items-center justify-center">
          {animPhase === "text" && (
            <span className="absolute inset-0 rounded-full"
              style={{ background: "radial-gradient(circle, rgba(16,185,129,0.18) 0%, transparent 70%)", animation: "pulse 2s ease-in-out infinite" }} />
          )}
          <div style={{
          ...
          <svg viewBox="0 0 48 48" width={44} height={44} fill="none"
            className="absolute inset-0 m-auto" style={{ pointerEvents: "none" }}>
