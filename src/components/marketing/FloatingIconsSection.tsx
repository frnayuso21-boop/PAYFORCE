...
function VisaLogo() {
  return (
    <svg viewBox="0 0 100 32" className="h-5 w-16">
      <text x="2" y="26" fontFamily="'Helvetica Neue', Arial, sans-serif" fontSize="28" fontWeight="700"
...
function BizumLogo() {
  return (
    <svg viewBox="0 0 80 32" className="h-6 w-16">
      ...
      <text x="4" y="24" fontFamily="'Helvetica Neue', Arial, sans-serif" fontSize="22" fontWeight="800"
        fill="#00ADEF" letterSpacing="-0.5">bizum</text>
    </svg>
  );
}
...
function ShopifyLogo() {
  return (
    <svg viewBox="0 0 80 32" className="h-6 w-20">
      <text x="0" y="24" fontFamily="'Helvetica Neue', Arial, sans-serif" fontSize="22" fontWeight="700"
        fill="#96BF48">shopify</text>
    </svg>
  );
}
...
function PayForceCard() {
  return (
    <div className="relative overflow-hidden rounded-2xl"
      ...
      {/* Glow círculo */}
      <div className="absolute -right-4 -bottom-4 rounded-full"
        style={{ width: 100, height: 100, background: "radial-gradient(circle, rgba(124,58,237,0.4) 0%, transparent 70%)" }}/>
    ...
    <div className="relative rounded-2xl overflow-hidden"
      ...
      <div className="px-5 py-4 flex flex-col gap-2">
        {[
          ...
          <div key={m.label} className="flex items-center gap-3 rounded-xl px-3 py-2.5"
            style={{
      ...
      <div className="px-5 pb-5">
        <div className="w-full rounded-xl py-3 text-center text-[12px] font-medium text-white"
          style={{ background: "#ffffff", color: "#111111", boxShadow: "0 4px 16px rgba(0,0,0,0.25)" }}>
          Pagar con Apple Pay
        </div>
...
export function FloatingIconsSection() {
  ...
  return (
    <section
      className="relative overflow-hidden px-4 py-24 md:px-8 mx-4 md:mx-8"
      style={{
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 opacity-[0.16]"
        style={{ backgroundImage: NOISE, backgroundSize: "160px", mixBlendMode: "soft-light" }} />

      {/* 3. Glow violeta vibrante — top-right */}
      <div className="pointer-events-none absolute inset-0"
        style={{ background: "radial-gradient(ellipse 55% 45% at 90% 8%, rgba(130,50,255,0.55) 0%, transparent 58%)" }} />

      {/* 4. Glow indigo — bottom-left */}
      <div className="pointer-events-none absolute inset-0"
        style={{ background: "radial-gradient(ellipse 50% 45% at 6% 92%, rgba(50,80,230,0.35) 0%, transparent 55%)" }} />
      ...
      <div className="relative z-10 mb-12 text-center px-4 md:mb-16 md:px-6">
        ...
        <h2 className="text-[30px] tracking-tight text-white leading-tight md:text-[54px]"
