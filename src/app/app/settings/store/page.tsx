      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
          ...
          <div className="px-6 py-5 border-b border-slate-100">
            ...
            <textarea
              rows={3}
              placeholder="Describe brevemente tu negocio para tus clientes…"
              value={desc}
          ...
          <div className="px-6 py-5">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <button
                ...
                className="relative h-8 w-8 rounded-xl border-2 border-dashed border-slate-300 hover:border-slate-500 transition flex items-center justify-center text-slate-400 text-[10px] font-bold overflow-hidden"
