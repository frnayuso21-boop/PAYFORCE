...
export function ProductsSection() {
 ...
 <span className="inline-block mb-4 rounded-full px-3 py-1 text-[10px] tracking-[2px] uppercase md:text-[11px] md:tracking-[3px]"style={{ background: "rgba(13,223,200,0.12)", border: "1px solid rgba(13,223,200,0.30)", color: "#0891B2"}}>
 Productos
 </span>
 <h2 className="text-[30px] leading-tight text-black md:text-[56px]"style={{ letterSpacing: "-0.03em", fontWeight: 400 }}>
 ...
 key={p.name}
 href={p.href}
 className="group relative flex flex-col gap-4 rounded-2xl p-6 transition-all duration-300 hover:-translate-y-0.5"style={{
 background: "#ffffff",
 ...
 >
 {/* Glow en hover */}
 <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"style={{ background: `radial-gradient(ellipse 80% 60% at 30% 30%, ${p.glow} 0%, transparent 70%)`}} />

 {/* Icono */}
 <div className="relative flex h-11 w-11 items-center justify-center rounded-xl"style={{ background: `${p.color}18`, border: `1px solid ${p.color}30`}}>
 ...
 {p.pills.map((pill) => (
 <span key={pill} className="rounded-full px-2.5 py-0.5 text-[11px]"style={{ background: "rgba(0,0,0,0.05)", color: "rgba(0,0,0,0.70)", border: "1px solid rgba(0,0,0,0.08)"}}>
 {pill}
 </span>
 ))}
 </div>
 ...
 {/* Arrow */}
 <div className="relative flex items-center gap-1 text-[12px] opacity-0 group-hover:opacity-60 transition-opacity"style={{ color: p.color }}>
 ...
 <Link href="/solutions"className="inline-flex items-center gap-2 rounded-full px-8 py-3.5 text-[15px] transition-all hover:opacity-80"style={{ background: "#ffffff", border: "1px solid rgba(0,0,0,0.10)", color: "rgba(0,0,0,0.70)"}}>
