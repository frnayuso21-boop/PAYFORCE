    ...
    <div className="min-h-screen bg-[#f8f9fb] p-8">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-3 gap-4">
          <MetricCard
            label="Ingresos totales" color="text-emerald-600"
          ...
          <MetricCard
            label="Pagos totales"
            value={(data.totalPayments ?? 0).toLocaleString("es-ES")}
            sub="Transacciones procesadas"
          />
          <MetricCard
            label="Pagos este mes"
            value={(data.monthPayments ?? 0).toLocaleString("es-ES")}
          />
          <MetricCard
            label="Clientes"
            value={(data.totalCustomers ?? 0).toLocaleString("es-ES")}
            sub="Clientes únicos"
          />
