...
export default async function ConnectPage() {
 ...
 <Button
 size="sm"variant="outline"className="shrink-0 border-emerald-300 text-emerald-700 hover:bg-emerald-100"asChild
 >
 ...
 item.disabled
 ? "opacity-50 cursor-not-allowed": "hover:border-slate-300 hover:bg-slate-50"}`}
 >
