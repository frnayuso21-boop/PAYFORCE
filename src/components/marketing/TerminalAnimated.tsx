  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: "#1e1e2e", borderRight: "1px solid rgba(255,255,255,0.07)" }}
      >
        {/* macOS bar */}
        <div
        ...
        {/* Cuerpo del terminal */}
        <div
          className="flex-1 px-5 py-4 text-[12.5px] leading-[1.7] overflow-hidden"
          style={{ minHeight: 0 }}
        >
        ...
        {/* Footer: estado TITAN */}
        <div
          className="px-5 py-2.5 text-[10px] flex items-center gap-3 shrink-0"
          style={{ borderTop: "1px solid rgba(255,255,255,0.06)", background: "#181825" }}
        >
      ...
      <div
        ...
        style={{ width: "42%", minWidth: 220, background: "#16213e" }}
      >
        {/* Header */}
        <div
        ...
        <div className="flex-1 overflow-hidden flex flex-col">
          {events.map(e => {
            ...
            return (
              ...
              >
                <span
                  className="text-[9px] font-bold rounded px-1.5 py-0.5 w-fit"
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              <div
                ...
                style={{ background: "rgba(189,147,249,0.22)", color: "#bd93f9" }}
              >
                P
              </div>
            ...
            <span
              ...
              style={{ background: "rgba(80,250,123,0.14)", color: "#50fa7b" }}
            >
              Pro
            </span>
          </div>
          ...
          <div className="w-full rounded-full h-1.5" style={{ background: "rgba(255,255,255,0.08)" }}>
            <div
              ...
              style={{ width: "68%", background: "linear-gradient(90deg,#bd93f9,#50fa7b)" }}
            />
          </div>
