...
function MotoCardInner({
 ...
 <input
 type="text"autoComplete="cc-name"value={holderName}
 onChange={(ev) => setHolderName(ev.target.value)}
 placeholder="Como figura en la tarjeta"style={textInput}
 required
 />
 ...
 <button
 type="submit"style={{ ...primaryBtn, opacity: busy || !cardComplete || !holderName.trim() ? 0.55 : 1 }}
