...
export function DashboardOverviewClient() {
  ...
  return (
    ...
    >
      {/* ══ SIDEBAR ══ */}
      <div
        className="flex flex-col shrink-0 py-4 px-2.5 gap-0.5"
        style={{ width: 148, background: "#0f172a", borderRight: "1px solid rgba(255,255,255,0.06)" }}
      >
        {/* Logo */}
        ...
        {/* TITAN badge */}
        <div
          className="mt-auto mx-1 rounded-xl p-2.5"
        ...
        <div className="p-3 flex flex-col gap-2.5 overflow-hidden flex-1">
          ...
          <div className="grid gap-2" style={{ gridTemplateColumns: "1fr 180px" }}>
            ...
            <div className="rounded-xl p-3 bg-white" style={{ border: "1px solid #f1f5f9" }}>
              ...
              <div className="relative select-none">
                ...
                >
                  ...
                  {SERIES.map((s, i) => (
                    <g key={s.day}>
                      ...
                      <text x={xs[i]} y={H-1} textAnchor="middle" fontSize="7" fontFamily="system-ui"
                        fill={i === n-1 || hovered === i ? "#6366f1" : "#94a3b8"}
                ...
                {hovered !== null && (
                  ...
                  >
                    <div className="rounded-lg px-2.5 py-1.5 shadow-xl"
                      style={{ background: "#0f172a", border: "1px solid rgba(99,102,241,0.3)", whiteSpace: "nowrap" }}>
            ...
            <div className="rounded-xl p-3 bg-white flex flex-col gap-2" style={{ border: "1px solid #f1f5f9" }}>
              ...
              <button className="mt-auto w-full rounded-lg py-1.5 text-[8.5px] font-bold text-white"
            ...
            <div>
              ...
              {PAYMENTS.map((p, i) => (
                <div key={i} className="grid items-center px-3 py-1.5"
                  style={{ gridTemplateColumns: "80px 1fr 70px 60px 50px", borderTop: i > 0 ? "1px solid #f8fafc" : "none" }}>
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-[8px] rounded-full px-1.5 py-0.5 font-medium"
                      style={{ background: p.ok ? "#f0fdf4" : "#eff6ff", color: p.ok ? "#15803d" : "#1d4ed8" }}>
                      {p.status}
                    </span>
                  </div>
                  <span className="text-[8.5px] text-slate-600 truncate pr-2">{p.name}</span>
                  <span className="text-[8.5px] font-bold text-slate-900 tabular-nums"
                    style={{ textDecoration: !p.ok ? "line-through" : "none", color: !p.ok ? "#94a3b8" : "#0f172a" }}>
                    {p.amount}
                  </span>
